...
{
    // The preprocessor directives give instruction to the compiler to preprocess 
    // the information before actual compilation starts.
    // Begins with #, does not end with a semicolon (;).
    // #define  It defines a sequence of characters, called symbol.
    // #undef   It allows you to undefine a symbol.
    // #if      It allows testing a symbol or symbols to see if they evaluste to true.
    ...
    // #endif   Specifies the end of conditional directive.
    // #line    It lets you modify the compiler's line number and (optionally) the file 
    //          name output for errors and warnings.
    ...
    //          your code.
    // #region  It lets you specify a block of code that you can expand or collapse when
